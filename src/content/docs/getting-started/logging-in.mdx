...
import loginSettings from '@assets/logging-in/login-settings.webp';
import userSettings from '@assets/logging-in/user-settings.webp';
import themeSettings from '@assets/logging-in/theme-settings.webp';
...
Visit [Canada Soccer's COMET platform](https://comet.canadasoccer.com/) to login with the username and password provided in your email.
...
Download and install the COMET Football application from either the [iOS app store](https://apps.apple.com/ca/app/comet-football/id1568506776) for Apple devices, or [Google Play Store](https://play.google.com/store/apps/details?id=de.analyticom.newCometMobile&hl=en_CA&gl=US) for Android devices.

When you run the application, a login screen will appear. Scroll through the federations at the top until you are on CSA with the Canada Soccer logo. Make sure "PROD" is selected and highlighted in blue instead of "DEMO". Then, you can log in with your username and password provided in your email.

import mobileLogin from '@assets/logging-in/mobile-login.png';

<Image
  src={mobileLogin}
  alt='The mobile login screen for COMET Football. CSA is the selected federation, "PROD" is selected and highlighted in blue instead of "DEMO", and there is a form to log in with your username and password.'
/>
