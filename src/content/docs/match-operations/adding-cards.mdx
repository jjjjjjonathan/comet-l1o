...
If you want to change the event type on mobile (for example, from a yellow card to a red card), you need to delete the event and create a new one. Press on a player's name who has the associated match events you want to edit or delete.
