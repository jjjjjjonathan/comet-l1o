...
To start a patch, press **IN PROGRESS**. The exact time that you pressed the button will be recorded which will be used to calculate the current minute of a match.
