...
<Image src={searchSidebar} alt='A zoomed-in screenshot of the COMET web application. A red box highlights the sidebar where the Players tab and Search Players console resides.' />
...
<Image src={searchPlayer} alt='The form to search for players within COMET. A red box highlights key form fields: Family Name, First Name, and Date of Birth' />
...
<Image src={searchActiveRegistrations} alt='The active registrations section to search for players within COMET. A red box highlights key form fields: Organisation and Club' />
...
<Image src={searchResults} alt='The search results after searching for a player within COMET. A red box highlights the fields where you can narrow your search further: ID, Name, Date of Birth, and Club' />
