...
If the player you're looking to register comes up in your search results, skip over to the section on [registering existing COMET players](#the-searched-player-is-already-in-comet). Otherwise, continue on to register a new player to COMET and your club.
