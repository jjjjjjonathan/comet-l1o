...
import searchSidebar from '@assets/registrations/players/search-sidebar.webp';
import searchPlayer from '@assets/registrations/players/search-player.webp';
import searchActiveRegistrations from '@assets/registrations/players/search-active-registrations.webp';
import searchResults from '@assets/registrations/players/search-results.webp';
import firstRegistration from '@assets/registrations/players/first-registration.webp';
import playerRegistrationLeft from '@assets/registrations/players/player-registration-left.webp';
import playerRegistrationRight from '@assets/registrations/players/player-registration-right.webp';
import playerActiveRegistrations from '@assets/registrations/players/player-active-registrations.webp';
...
Click on the **Players** tab in the left sidebar to open a list of more options, and click on **Search Players** to open up the console on another page as highlighted in the red box of the image below.
...
In the active registrations section under the search form, I also suggest clicking the X beside "Organisation" and "Club" to leave those fields because those would limit to your search to only within that governing body or club (for example, you would use that to only search for players with registrations in Ontario Soccer).
...
<Image
  ...
  alt='The active registrations section to search for players within COMET. A red box on top highlights the registration status where all checkboxes should be unchecked. A red box on the bottom highlights form fields for Organisation and Club which should also be left blank.'
/>
...
If the player you're looking to register comes up in your search results, click on their name to go to their person page, and skip over to the section on [registering existing COMET players](#the-searched-player-is-already-in-comet). Otherwise, continue on to register a new player to COMET and your club.
...
If a player isn't in COMET, you'll be registering them into the system for the first time. Click on **First registration** under the Players tab in the left sidebar.
...
- **The common name is what shows up on League1 websites, the League1 Canada app, and official start lists and match reports. Please remember to include a person's first AND last name for the common name field.**
...
import newRegistrationExisting from '@assets/registrations/players/new-registration-existing.webp';

<Image
  src={newRegistrationExisting}
  alt='The active registrations section of a person page, with a red box highlighting the button that says New Registration'
/>
...
In the new registration page, ensure that the club listed in the form is your club, the discipline is **Football**, the registration type is **Registration** and the **Date from** is the current date.
